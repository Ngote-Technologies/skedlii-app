...
export default function OrganizationSwitcher({ 
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[calc(100vw-2rem)] max-w-[300px] md:w-[320px] p-0" align="start" side="bottom" sideOffset={4}>
        <Command>
          <div className="p-1">
            <CommandInput 
...
export function CompactOrganizationSwitcher({ 
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[calc(100vw-2rem)] max-w-[280px] md:w-[300px] p-0" align="start" side="bottom" sideOffset={4}>
        <Command>
          <div className="p-1">
            <CommandInput 
              placeholder="Search organizations..." 
