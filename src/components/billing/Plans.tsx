            ...
            <div className="relative h-full rounded-xl border border-border/50 bg-gradient-to-br from-background to-muted/30 p-6 backdrop-blur-sm">
              ...
              {plan.isPopular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <Badge className={`bg-gradient-to-r ${theme.gradient} text-white shadow-lg animate-pulse`}>
              ...
              <div className="relative space-y-4">
                ...
                >
                  ...
                  {plan.isPopular && !isCurrentPlan && <Zap className="h-4 w-4 mr-2" />}
