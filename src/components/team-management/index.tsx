...
export default function TeamManagement() {
  ...
  return (
    <PermissionGuard permission={Permission.TEAMS_VIEW}>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <PermissionGuard permission={Permission.TEAMS_CREATE}>
            ...
            {isLoadingTeams ? (
                  ...
                  return (
                    <Card key={team._id} className="overflow-hidden">
                      ...
                      <CardFooter className="flex flex-col gap-2 border-t pt-4 bg-muted/40">
                        ...
                        <PermissionGuard permission={Permission.TEAMS_DELETE}>
                          <Button
                            variant="destructive"
                            className="w-full"
              ...
              <Card className="border-dashed">
                <CardHeader>
                  ...
                  <CardDescription>
                    Create a team to collaborate with others on your social
                    media content
                  </CardDescription>
                </CardHeader>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                action cannot be undone. All team members will be removed from
                the team.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
